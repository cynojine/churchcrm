                    ...
                    <div class="content-side content-side-full">
                        <ul class="nav-main">
                            ...
                            <li class="open">
                                ...
                                <ul>
                                    <li class="open">
                                        <a class="nav-submenu" data-toggle="nav-submenu" href="#"><span class="sidebar-mini-hide">Add Members</span></a>
                                        <ul>
                                            <li>
                                                <a class="active" href="be_pages_dashboard2.html"><span class="sidebar-mini-hide">Members List</span></a>
                                            </li>
